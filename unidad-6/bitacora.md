...
En cada actividad, analicé ventajas y desventajas, consideré alternativas de implementación y reflexioné sobre principios de diseño. Considero que merezco el 5.0 por haber completado todas las actividades, demostrado comprensión profunda de los tres patrones de diseño, y aplicado los conceptos de manera creativa. No respondí explícitamente las preguntas opcionales, pero considero que todas ellas quedaron explicadas dentro de mis evidencias en la bitácora, porque me aseguré de que mis respuestas fueran detalladas y precisas. Muchas de ellas pedían cosas como identificar quién cumplía cada rol, pero eso podía explicarlo con mayor claridad desde el diagrama que se pedía obligatoriamente más adelante. Fue una cuestión de criterio propio.  
